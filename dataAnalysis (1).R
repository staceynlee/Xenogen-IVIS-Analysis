# This code analyzes data generated from bioluminescence imaging of transgenic mice.
# The code takes txt files generated by the Xenogen IVIS analysis software from ROI measurements on each mouse.
# This specific experiment analysis combines a pre treatment reading, 4-day post treatment reading, and 6-day post treatment reading.
# I combine the datasets, add missing information about the mouse number, genotype, and day of reading, and plot the data.
